...
.search-container { width: 620px; max-width: 90%; background: white; padding: 6px 6px 6px 16px; border-radius: 40px; display: flex; align-items: center; box-shadow: 0 6px 20px rgba(0,0,0,0.08); margin-bottom: 24px; }
